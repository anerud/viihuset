...
class ModuleInfoAdminView implements iView{
	...
	public function render(){
        ...
        <div id="moduleInfoAdminView">
            ...
            <form action='/<?php echo $this->moduleInfo->name?>/moduleInfo' method='post' class='form moduleInfoForm' autocomplete='off'>
                <h3>Rubrik</h3>
				...
				<input type="hidden" name="sortindex" value="<?php echo $this->moduleInfo->sortindex;?>">
