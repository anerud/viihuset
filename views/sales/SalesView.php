				...
				<div class='content'>
					<div class='text'>
						...
						<div class='bubble'>
							...
							<a href='/brfviihuset'>Klicka här</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class='content'>
				<div class='sidebar'>
					...
					<ul class='list'>
						...
						<li>
							<b>Vi gör jobbet!</b>
							<p>Låt oss <b>skapa</b>, <b>underhålla</b> samt <b>uppdatera</b> er sida! Med abonnemang hos Vi i huset, är uppdateringen av er sida bara ett telefonsamtal bort. Givetvis kan man ändra och uppdatera allt innehåll själv via vårt användarvänliga publiceringsverktyg.</p>
						</li>
					</ul>
				</div>
				<div class='con'>
					...
					<div class='divide'>
						<input type='text' name='reg_brf' value='' placeholder='Bostadsrättsföreningens namn...' tabindex='2' />
						<input type='text' name='reg_email' value='<?=$log_mail;?>' placeholder='E-postadress ...' tabindex='3' />
						<input type='password' name='reg_pass' value='' placeholder='Lösenord ...' tabindex='4' />
						<input type='password' name='reg_pass_re' value='' placeholder='Upprepa lösenord ...' tabindex='5'' />
					</div>
					<button type='submit'><img src='gfx/bigReg.png' alt='Registrera förening' /></button>
					</form>
				</div>
			</div>
